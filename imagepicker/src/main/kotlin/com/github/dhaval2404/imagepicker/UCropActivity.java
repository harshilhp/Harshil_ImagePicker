...
//        mOverlayView.setCropGridCornerColor(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_CORNER_COLOR, getResources().getColor(com.yalantis.ucrop.R.color.ucrop_color_default_crop_grid)));
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mActiveControlsWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_CONTROLS_WIDGET_ACTIVE, ContextCompat.getColor(this, com.yalantis.ucrop.R.color.ucrop_color_active_controls_color));
        ...
        if (mShowBottomControls) {
            ...
            ViewGroup viewGroup = findViewById(com.yalantis.ucrop.R.id.ucrop_photobox);
            ViewGroup wrapper = viewGroup.findViewById(com.yalantis.ucrop.R.id.controls_wrapper);
            wrapper.setVisibility(View.VISIBLE);
            LayoutInflater.from(this).inflate(com.yalantis.ucrop.R.layout.ucrop_controls, wrapper, true);
    ...
    private void initiateRootViews() {
        ...
        if (!mShowBottomControls) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) findViewById(com.yalantis.ucrop.R.id.ucrop_frame).getLayoutParams();
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        if (aspectRatioList == null || aspectRatioList.isEmpty()) {
            ...
            aspectRatioList.add(new AspectRatio(getString(com.yalantis.ucrop.R.string.ucrop_label_original).toUpperCase(),
    ...
    private void setupRotateWidget() {
        ...
        ((HorizontalProgressWheelView) findViewById(com.yalantis.ucrop.R.id.rotate_scroll_wheel)).setMiddleLineColor(mActiveControlsWidgetColor);
    ...
    private void setupScaleWidget() {
        ...
        ((HorizontalProgressWheelView) findViewById(com.yalantis.ucrop.R.id.scale_scroll_wheel)).setMiddleLineColor(mActiveControlsWidgetColor);
    ...
    private void changeSelectedTab(int stateViewId) {
        TransitionManager.beginDelayedTransition((ViewGroup) findViewById(com.yalantis.ucrop.R.id.ucrop_photobox), mControlsTransition);

        mWrapperStateScale.findViewById(com.yalantis.ucrop.R.id.text_view_scale).setVisibility(stateViewId == com.yalantis.ucrop.R.id.state_scale ? View.VISIBLE : View.GONE);
        mWrapperStateAspectRatio.findViewById(com.yalantis.ucrop.R.id.text_view_crop).setVisibility(stateViewId == com.yalantis.ucrop.R.id.state_aspect_ratio ? View.VISIBLE : View.GONE);
        mWrapperStateRotate.findViewById(com.yalantis.ucrop.R.id.text_view_rotate).setVisibility(stateViewId == com.yalantis.ucrop.R.id.state_rotate ? View.VISIBLE : View.GONE);
